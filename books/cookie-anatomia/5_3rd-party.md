---
title: "3rd Party Cookie はなぜ問題になるのか?"
emoji: "📝"
type: "tech"
...
# 3rd Party Cookie はなぜ問題になるのか?

3rd Party Cookie が話題に上がる場合、それは大抵ではネガティブなものだろう。特に平成の間は、それこそあらゆるサイトで使われていた 3rd Party Cookie が、平成の後半からどんどん「問題視」されるようになり、令和に差し掛かる頃には、多くの法律や条例に絡み始め、今では主要なブラウザが 3rd Party Cookie の廃止を掲げて Web のあり方が大きく動いている。

3rd Party Cookie とはそもそも何だったのか、そして何が問題で、これからどうなって行こうとしているのか。順を追って解説したい。

## 注意
ここで改めて書いておくが、本書で書いている内容はあくまで標準仕様などに基づくものや、開発における一般論についてだ。そしてそれらはあくまで参考であり、実務などにあたっては、必ず自身で確認検証を行ってから実装するべきであり、なにか問題が発生しても自己責任となる。

しかし、ここからの話には純粋な技術上の話ではなく、法律や条例の話が絡んでくる。筆者は Web 技術が専門であり、法律などは専門外だ。従ってあくまで技術の視点から書くことしかできないため、特に後述する GDPR / CPPA / 個人情報保護法案などについては、参考として触れることはあるが、実務上何か絡むのであれば専門家の意見を仰ぐべきだ。


## 1st party と 3rd party cookie
